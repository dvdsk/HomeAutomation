...
pub enum Reading {
    Temperature(f32) = 0,
    Heating(f32) = 1,
    SetBy(crate::shared::radiator::Source) = 2,
    Setpoint(f32) = 3,
}
        ...
        let leaf = match self {
            ...
            Reading::SetBy(val) => Info {
                ...
                label_formatter: Box::new(
                    crate::shared::radiator::SetByLabelFormatter,
                ),
            },
    ...
    pub const fn info(&self) -> crate::DeviceInfo {
        crate::DeviceInfo {
            ...
            affects_readings: &tree![Reading; 
                Reading::Temperature(0.0), Reading::Heating(0.0), 
                Reading::SetBy(crate::shared::radiator::Source::Manual), 
