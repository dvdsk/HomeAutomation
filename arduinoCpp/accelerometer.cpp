...
////    
//int Accelerometer::MMA7455_init(void)
//{
//  uint16_t x, y, z;
//  int error;
//  xyz_union xyz;
...
////
//int Accelerometer::MMA7455_xyz( uint16_t *pX, uint16_t *pY, uint16_t *pZ)
//{
//  xyz_union xyz;
//  int error;
//  uint8_t c;
...
////
//int Accelerometer::MMA7455_read(int start, uint8_t *buffer, int size)
//{
//  int i, n, error;
...
//// There is no function for a single byte.
////
//int Accelerometer::MMA7455_write(int start, const uint8_t *pData, int size)
//{
//  int n, error;
