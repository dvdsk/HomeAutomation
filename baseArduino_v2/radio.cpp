...
: RF24(pin::RADIO_CE, pin::RADIO_CS){
  ...
  RF24::setPayloadSize(5);                // Here we are sending 1-byte payloads to test the call-response speed
...
void RemoteNodes::poll_N1(){
  ...
  RF24::write(&currentRq_N1, 1); //write currentRq to the currently opend writingPipe  
  if(RF24::available() ){
